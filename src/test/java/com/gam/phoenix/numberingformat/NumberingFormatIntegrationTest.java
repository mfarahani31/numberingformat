...
class NumberingFormatIntegrationTest {
    ...
    public void given_getNumberingFormatByFormatAndUsage_when_usage_and_format_are_valid_then_return_numberingFormat() throws DalException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(NumberingFormatController.NUMBERING_FORMAT_URL + "/test1/test1", HttpMethod.GET, MotherObject.getValidHttpEntityWithHeaderUsernameAdmin(), String.class);
    ...
    public void given_getNextSerial_when_usage_and_format_are_valid_then_return_nextSerial() throws DalException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(NumberingFormatController.NUMBERING_FORMAT_URL + "/test1/test1/next", HttpMethod.GET, MotherObject.getValidHttpEntityWithHeaderUsernameAdmin(), String.class);
...
//        assertEquals(MotherObject.getAnyValidNumberingFormat().getStartAt(), response.getBody().getStartAt());
    ...
    public void given_getNumberingFormatByFormatAndUsage_when_numberingFormat_not_exist_then_return_error() throws DalException {
        ...
        ResponseEntity<String> response = restTemplate.exchange(NumberingFormatController.NUMBERING_FORMAT_URL + "/invalidUsage/invalidFormat", HttpMethod.GET, MotherObject.getValidHttpEntityWithHeaderUsernameAdmin(), String.class);
    ...
    public void given_deleteNumberFormat_when_numberingFormat_not_exist_then_returns_500() throws DalException {
        ...
        assertThrows(DalException.class, () -> numberingFormatService.deleteNumberingFormat(MotherObject.getAnyValidNumberingFormat().getNumberUsage(), MotherObject.getAnyValidNumberingFormat().getNumberFormat()));
